...
ActiveRecord::Schema.define(version: 20160802182934) do
  ...
  add_index "veterans", ["reset_password_token"], name: "index_veterans_on_reset_password_token", unique: true, using: :btree
