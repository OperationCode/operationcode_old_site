...
In your local/development environment, you can do a "dry run" publish to preview how your post will looks when it eventually is published:
...
*thanks to Chris Kibble for creating the intial version of both our Jekyll blog and this guide*
#Operation Code Blog Posting Guide
##Sources
[Jekyll Docs](http://jekyllrb.com/docs/home/)  
[Tutorial for merging Jekyll into existing Rails app](http://www.nickhammond.com/the-super-simple-way-to-add-a-jekyll-based-blog-in-your-rails-application/)  
...
*thanks to [Chris Kibble](https://github.com/ckib16) for creating the intial versions of our Jekyll blog and this guide*