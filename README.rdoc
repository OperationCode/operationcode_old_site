...
*Contributing* - Everyone is encouraged to contribute to the project by forking and submitting a pull request. Current contributors: 
...
*Spread the Word* - Join the conversation on [Twitter](https://twitter.com/operation_code) and [sign up](http://operationcode.org/action) to join the #operationcode movement. 

*Moving Soon* - Simultaneously, we'll be moving to a GitHub [organizational repo](https://github.com/operationcode) to better coordinate our efforts with developers. Thanks to [Chris Hough](https://twitter.com/chrishough) for leading the first charge. 
...
Thank you. We couldn't have come this far without your feedback, comments, thoughts, advice and generous resource suppport. 